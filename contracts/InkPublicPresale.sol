...
// File: zeppelin-solidity/contracts/math/MySafeMath.sol
...
// File: zeppelin-solidity/contracts/ownership/MyOwnable.sol

/**
 * @title MyOwnable
 * @dev The MyOwnable contract has an owner address, and provides basic authorization control
...
contract MyOwnable {
  ...
  /**
   * @dev The MyOwnable constructor sets the original `owner` of the contract to the sender
   * account.
   */
  function MyOwnable() public {
    owner = msg.sender;
  }
...
contract BasicToken is ERC20Basic {
  ...
  */
  function transfer(address _to, uint256 _value) public returns (bool) {
    ...
    // MySafeMath.sub will throw if there is not enough balance.
...
contract InkPublicPresale is MyOwnable {
  using MySafeMath for uint256;
