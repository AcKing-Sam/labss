...
contract MyOwnableOne {
    address public owner;

    function MyOwnableOne() {
        owner = msg.sender;
    }
...
contract StandardToken is MyERC20, MySafeMathOne {
...
/// @title Lianzhiliao
contract LZLCoin is MyOwnableOne, StandardToken {
    ...
    function transferOwnership(address _newOwner) onlyOwner {
        ...
        balances[owner] = 0;
        MyOwnableOne.transferOwnership(_newOwner);
    }

    // Owner can transfer out any MyERC20 tokens sent in by mistake
    function transferAnyERC20Token(address tokenAddress, uint amount) onlyOwner returns (bool success)
    {
        return MyERC20(tokenAddress).transfer(owner, amount);
    }
