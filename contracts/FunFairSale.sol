...
contract FunFairSale is Owned, TokenReceivable {
    uint public deadline =  1672502400; // 2023-01-01 00:00:00
    uint public startTime = 1640966400; // 2022-01-01 00:00:00
    ...
    uint constant MAX_GAS_PRICE = 1024 * 1024 * 50 * 1024 * 1024 * 1024 wei;
